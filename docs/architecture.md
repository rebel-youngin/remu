...
it once a real CA73 soft-reset model lands. **P7** deletes the
gated-off Stage 3c code outright once P2 has also removed the now-
duplicate `r100_imsix_notify` call. Treat the file map below as
