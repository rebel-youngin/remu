...
| Program engines (DNC / RBDMA / HDMA) | q-cp HAL drivers writing engine MMIO | Engine MMIO partly modelled (DNC done-IRQ ✓, HDMA reg block ✓, RBDMA done-IRQ ✓ P4A); q-cp never programs them because Stage 3c short-circuits the chain |
